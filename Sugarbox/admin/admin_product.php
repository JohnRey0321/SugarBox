<?php 
    ...
    if (isset($_POST['add_product'])){
        ...
        if(mysqli_num_rows($select_product_name) > 0 ){;
            ...
            $insert_product = mysqli_query($conn, "INSERT INTO `products` (`name`, `price`, `product_detail`, `category`, `stock`, `image`) VALUES ('$product_name', '$product_price', '$product_detail', '$product_category', '$product_stock', '$image')") or die ('query failed');
            if ($insert_product){
    ...
    if (isset($_POST['update_product'])){
        ...
        $update_query = mysqli_query($conn, "UPDATE `products` SET `id` = '$update_id', `name` = '$update_name', `price` = '$update_price', `product_detail` = '$update_detail', `stock` = '$update_stock', `image` = '$update_image' WHERE id = '$update_id'") or die ('query failed');
    ...
    ?>
        ...
        <section class="add-products form-container">
            <form method="POST" enctype="multipart/form-data">
                ...
                <?php 
                        $select_category = mysqli_query($conn, "SELECT * FROM `products`") or die ('query failed');
                        if (mysqli_num_rows($select_category) > 0){
                            ...
                            ?>        
                                ...
                                <option value="Customize Cake">Customize Cake</option>
                                <option value="Dessert">Dessert</option>
                                <option value="Balloons and Sticker">Balloons and Sticker</option>             
            ...
            <section class="show-products">
                <div class="box-container">
                    ...
                    <div class="box">
                                ...
                                <p class="p_price">price: ₱ <?php echo $fetch_products['price']; ?> /-</p>
                                <p class='category'>Category: <?php echo $fetch_products['category']; ?></p>
                                <p class='stock'>Stocks left: <?php echo $fetch_products['stock']; ?></p>
            ...
            <div class="line">
                <section class="update-container">
                    ...
                    <form method="POST" enctype="multipart/form-data">
                            ...
                            <input type="number" name="update_stock" value="<?php echo $fetch_edit['stock']; ?>">
